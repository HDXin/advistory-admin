<template>
  <page>
    <el-row slot="header">
      <el-col :span="20">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item>参考曲线数据信息</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
      <el-col :span="4"
              class="text-right">
    ...
    <reference-curve-info-edit :visible.sync="dialogVisible" />
  </page>
</template>
<script>
import { mixin } from "@/mixins/search";
import { articleApi } from "@/api";
import ReferenceCurveInfoEdit from "@/components/quotes/ReferenceCurveInfoEdit";
export default {
  mixins: [mixin],
  components: {
    ReferenceCurveInfoEdit
  },
  data() {
    return {
      queryParams: {
